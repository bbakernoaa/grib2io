...
XLOC_EXPECTED = np.array(
    [1973.6736, 1799.815, 1864.3274, 1530.0651, 952.95715, 322.15088, np.nan],
    dtype=np.float32,
)

YLOC_EXPECTED = np.array(
    [813.0962, 819.43164, 168.9331, 865.2627, 774.5322, 759.9668, np.nan],
    dtype=np.float32,
)

INTERP_DATA_EXPECTED = np.array(
    [294.86902, 291.91238, 298.9, 292.80173, 296.71338, 295.3439, np.nan],
    dtype=np.float32,
)
