...
def test_section1_attrs(request):
    ...
    with grib2io.open(data / 'gfs.t00z.pgrb2.1p00.f012_subset') as f:
        msg = f['REFC'][0]
    expected_section1 = np.array([7, 0, 2, 1, 1, 2022, 11, 7, 0, 0, 0, 0, 1])
...
def test_section4(request):
    ...
    assert msg.unitOfSecondFixedSurface is None
    ...
    assert (
        msg.generatingProcess.definition
        == 'Global Forecast System Model T1534 - Forecast hours 00-384 T574 - Forecast hours 00-192 T190 - Forecast hours 204-384'
    )
