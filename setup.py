...
if g2c_static:
    ...
    for lib in dep_libraries:
        libname, incdir, libdir = get_package_info(lib, static=g2c_static)
        ...
        lib = pkgname_to_libname[lib][0]
        extmod_config["g2clib"]["extra_objects"].append(find_library(lib, dirs=[libdir], static=g2c_static))
...
# ----------------------------------------------------------------------------------------
cnt = """# This file is generated by grib2io's setup.py
