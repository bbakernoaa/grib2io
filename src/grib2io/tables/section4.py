...
table_4_0 = {
    ...
    '21-29': 'Reserved',
    '30': 'Satellite product (deprecated) (see Template 4.30)',
    ...
    '44': 'Analysis or forecast at a horizontal level or in a horizontal layer at a point in time for aerosol (deprecated) (see Template 4.44)',
    ...
    '50': 'Analysis or forecast at a horizontal level or in a horizontal layer at a point in time for aerosol. (see Template 4.50)',
    ...
    '128': 'Anomalies significance and other derived products from an analysis or forecast in relation to a reference period at a horizontal level or in a horizontal layer at a point in time (see Template 4.128)',
    '129': 'Anomalies significance and other derived products from an individual ensemble forecast, control and perturbed in relation to a reference period at a horizontal level or in a horizontal layer at a point in time (see Template 4.129)',
    '130': 'Anomalies significance and other derived products from derived forecasts based on all ensemble members in relation to a reference period at a horizontal level or in a horizontal layer at a point in time (see Template 4.130)',
    '131': 'Anomalies significance and other derived products as probability forecasts in relation to a reference period at a horizontal level or in a horizontal layer at a point in time (see Template 4.131)',
    '132': 'Quantile forecasts of anomalies, significance and other derived products in relation to a reference period at a horizontal level or in a horizontal layer at a point in time (see Template 4.132)',
    '133': 'Post-processed quantile forecasts of anomalies, significance and other derived products in relation to a reference period at a horizontal level or in a horizontal layer at a point in time (see Template 4.133)',
    '134': 'Quantile forecasts of anomalies, significance and other derived products in relation to a reference period at a horizontal level or in a horizontal layer in a continuous or non-continuous time interval (see Template 4.134)',
    '135': 'Post-processed quantile forecasts of anomalies, significance and other derived products in relation to a reference period at a horizontal level or in a horizontal layer in a continuous or non-continuous time interval (see Template 4.135)',
    '136': 'Probability forecasts of anomalies, significance and other derived products in relation to a reference period with spatiotemporal processing based on focal (moving window) statistics in relation to a reference period at a horizontal level or in at a point in time (see Template 4.136)',
    '137': 'Derived reforecast based on all ensemble members at a horizontal level or in a horizontal layer at a point in time (see Template 4.137)',
    '138': 'Derived reforecast based on all ensemble members at a horizontal level or in a horizontal layer in a continuous or non-continuous time interval (see Template 4.138)',
    '139': 'Reforecast at a horizontal level or in a horizontal layer at a point in time for waves selected by period range (see Template 4.139)',
    '140': 'Individual ensemble reforecast, control and perturbed, at a horizontal level or in a horizontal layer at a point in time for waves selected by period range (see Template 4.140)',
    '141': 'Reforecast at a horizontal level or in a horizontal layer at a point in time for wave 2D spectra with explicit list of frequencies and directions (see Template 4.141)',
    '142': 'Individual ensemble reforecast, control and perturbed, at a horizontal level or in a horizontal layer at a point in time for wave 2D spectra with explicit list of frequencies and directions (see Template 4.142)',
    '143': 'Random fields used in an ensemble forecast, at a horizontal level or in a horizontal layer at a point in time (see Template 4.143)',
    '144': 'Analysis or forecast at a horizontal level or in a horizontal layer in a continuous or non-continuous time interval for waves selected by period range (see Template 4.144)',
    '145': 'Individual ensemble forecast, control and perturbed, at a horizontal level or in a horizontal layer in a continuous or non-continuous time interval for waves selected by period range (see Template 4.145)',
    '146': 'Verification scores for analysis or forecast at a horizontal level or in a horizontal layer at a point in time (see Template 4.146)',
    '147': 'Verification scores for average, accumulation, and/or extreme values or other statistically processed values at a horizontal level or in a horizontal layer in a continuous or non-continuous time interval (see Template 4.147)',
    '148': 'Verification scores for individual ensemble forecast, control and perturbed, at a horizontal level or in a horizontal layer at a point in time (see Template 4.148)',
...
table_4_5 = {
    ...
    '21': [
        'Lowest level where mass density exceeds the specified value (base for a given threshold of mass density)',
        'kg m-3',
    ],
    '22': [
    ...
    '36': ['Stratopause', 'unknown'],
    '37-99': ['Reserved', 'unknown'],
    ...
    '190': ['Reserved', 'unknown'],
    '191': ['Abstract Level with no Vertical Localization (see Note 10)', 'unknown'],
...
table_4_9 = {
    ...
    '10': 'Probability of event within the quantile of the probability distribution function',
    '11-191': 'Reserved',
    '192-254': 'Reserved for Local Use',
    '255': 'Missing',
}
...
table_4_230 = {
    ...
    '22': ['Sulfate Anion', 'SO42-'],
    '23': ['Atomic Radon', 'Rn'],
    '24': ['Mercury Vapor', 'Hg(O)'],
    ...
    '40': ['Sulfuric Acid', 'H2SO4'],
    '41': ['Hydrogen Sulfide', 'H2S'],
    '42': ['Sulfur Trioxide', 'SO3'],
    '43': ['Bromine', 'Br2'],
    '44': ['Hydrofluoric Acid', 'HF'],
    '45': ['Sulfur Hexafluoride', 'SF6'],
    '46': ['Chlorine', 'Cl2'],
    '47-9999': ['Reserved', 'unknown'],
    ...
    '10014': ['Propane', 'C3H8'],
    '10015': ['Propene', 'C3H6'],
    '10016': ['Butane (all isomers)', 'C4H10'],
    '10017': ['Isoprene', 'C5H8'],
    ...
    '10022': ['Toluene', 'C7H8'],
    '10023': ['Xylene', 'C8H10'],
    '10024': ['Methanesulfonic Acid', 'CH3SO3H'],
    '10025': ['Methylglyoxal (2-Oxopropanal)', 'CH3C(O)CHO'],
    '10026': ['Peroxyacetyl Radical', 'CH3C(O)OO'],
    '10027': ['Methacrylic Acid (2-Methylprop-2-Enoic Acid)', 'CH2C(CH3)COOH'],
    '10028': ['Methacrolein (2-Methylprop-2-Enal)', 'CH2C(CH3)CHO'],
    '10029': ['Acetone (Propan-2-One)', 'CH3C(O)CH3'],
    '10030': ['Ethyl Dioxidanyl Radical', 'CH3CH2OO'],
    '10031': ['Butadiene (Buta-1,3-Diene)', '(CH2CH)2'],
    '10032': ['Acetaldehyde (Ethanal)', 'CH3CHO'],
    '10033': ['Glycolaldehyde (Hydroxyethanal)', 'HOCH2CHO'],
    '10034': ['Cresol (Methylphenol), All Isomers', 'CH3C6H4OH'],
    '10035': ['Peracetic Acid (Ethaneperoxoic Acid)', 'CH3C(O)OOH'],
    '10036': ['2-Hydroxyethyl Oxidanyl Radical', 'HOCH2CH2O'],
    '10037': ['2-Hydroxyethyl Dioxidanyl Radical', 'HOCH2CH2OO'],
    '10038': ['Glyoxal (Oxaldehyde)', 'OCHCHO'],
    '10039': ['Isopropyl Dioxidanyl Radical', '(CH3)2CHOO'],
    '10040': ['Isopropyl Hydroperoxide (2-Hydroperoxypropane)', '(CH3)2CHOOH'],
    '10041': ['Hydroxyacetone (1-Hydroxypropan-2-One)', 'CH3C(O)CH2OH'],
    '10042': ['Peroxyacetic Acid (Ethaneperoxoic Acid)', 'CH3C(O)OOH'],
    '10043': ['Methyl Vinyl Ketone (But-3-En-2-One)', 'CH3C(O)CHCH2'],
    '10044': ['Phenoxy Radical', 'C6H5O'],
    '10045': ['Methyl Radical', 'CH3'],
    '10046': ['Carbonyl Sulfide (Carbon Oxide Sulfide)', 'OCS'],
    '10047': ['Dibromomethane', 'CH2Br2'],
    '10048': ['Methoxy Radical', 'CH3O'],
    '10049': ['Tribromomethane', 'CHBr3'],
    '10050': ['Formyl Radical (Oxomethyl Radical)', 'HOC'],
    '10051': ['Hydroxymethyl Dioxidanyl Radical', 'HOCH2OO'],
    '10052': ['Ethyl Hydroperoxide', 'CH3CH2OOH'],
    '10053': ['3-Hydroxypropyl Dioxidanyl Radical', 'HOCH2CH2CH2OO'],
    '10054': ['3-Hydroxypropyl Hydroperoxide', 'HOCH2CH2CH2OOH'],
    '10055': ['Methyl-Peroxy-Nitrate (Nitroperoxy-Methane)', 'CH3OONO2'],
    '10056': ['4-Hydroxy-3-Methyl-1-Butene-3-Ylperoxy Radical', 'HOCH2C(CH3)(OO)CHCH2'],
    '10057': ['2-Hydroxy-1-Isopropenylethylperoxy Radical', 'HOCH2CH(OO)C(CH3)CH2'],
    '10058': ['(Z)-4-Hydroperoxy-2-Methyl-2-Butenal', 'CH2(OOH)CHC(CH3)CHO'],
    '10059': ['(Z)-4-Hydroperoxy-3-Methyl-2-Butenal', 'CH2(OOH)C(CH3)CHCHO'],
    '10060': ['Butene', 'C4H8'],
    '10061': ['Pentene', 'C5H10'],
    '10062': ['Hexene', 'C6H12'],
    '10063': ['Heptene', 'C7H14'],
    ...
    '10067': ['Heptane', 'C7H16'],
    '10068': ['Octane', 'C8H18'],
    '10069-10499': ['Reserved', 'unknown'],
    '10500': ['Dimethyl Sulfide', 'CH3SCH3'],
    '10501': ['Dimethyl Sulfoxide', '(CH3)2SO'],
    '10502-20000': ['Reserved', 'unknown'],
    '20001': ['Hydrogen Chloride', 'HCl'],
    '20002': ['CFC-11', 'CCl3F'],
    '20003': ['CFC-12', 'CCl2F2'],
    '20004': ['CFC-113', 'Cl2FC-CClF2'],
    '20005': ['CFC-113a', 'Cl3C-CF3'],
    '20006': ['CFC-114', 'ClF2C-CClF2'],
    '20007': ['CFC-115', 'ClF2C-CF3'],
    '20008': ['HCFC-22', 'CHClF2'],
    '20009': ['HCFC-141b', 'Cl2FC-CH3'],
    '20010': ['HCFC-142b', 'ClF2C-CH3'],
    '20011': ['Halon-1202', 'CBr2F2'],
    '20012': ['Halon-1211', 'CBrClF2'],
    '20013': ['Halon-1301', 'CBrF3'],
    '20014': ['Halon-2402', 'BrF2C-CBrF2'],
    '20015': ['Methyl Chloride (HCC-40)', 'CH3Cl'],
    '20016': ['Carbon Tetrachloride (HCC-10)', 'CCl4'],
    '20017': ['HCC-140a', 'Cl3C-CH3'],
    '20018': ['Methyl Bromide (HBC-40B1)', 'CH3Br'],
    '20019': ['Hexachlorocyclohexane (HCH)', 'C6H6Cl6'],
    '20020': ['Alpha Hexachlorocyclohexane', 'α-C6H6Cl6'],
    '20021': ['Hexachlorobiphenyl (PCB-153)', '(C6H2Cl3)2'],
    '20022': ['HCFC-141a', 'Cl2HC-CH2F'],
    '20023-29999': ['Reserved', 'unknown'],
    '30000': [
        'Radioactive Pollutant (Tracer, defined by originating centre)',
        'unknown',
    ],
    '30001-30009': ['Reserved', 'unknown'],
    '30010': ['Tritium (Hydrogen-3)', 'H-3'],
    '30011': ['Tritium Organic Bonded', 'H-3o'],
    '30012': ['Tritium Inorganic', 'H-3a'],
    '30013': ['Beryllium 7', 'Be-7'],
    '30014': ['Beryllium 10', 'Be-10'],
    '30015': ['Carbon 14', 'C-14'],
    '30016': ['Carbon 14 CO2', 'C-14CO2'],
    ...
    '30139': ['Iodine 131 organic bonded', 'I-131o'],
    '30140': ['Iodine 131 elementary gaseous and organic bonded', 'I-131go'],
    '30141': ['Iodine 131 aerosol', 'I-131a'],
    '30142': ['Iodine 132', 'I-132'],
    '30143': ['Iodine 132 elementary gaseous', 'I-132g'],
    '30144': ['Iodine 132 organic bonded', 'I-132o'],
    '30145': ['Iodine 132 elementary gaseous and organic bonded', 'I-132go'],
    '30146': ['Iodine 132 aerosol', 'I-132a'],
    '30147': ['Iodine 133', 'I-133'],
    '30148': ['Iodine 133 elementary gaseous', 'I-133g'],
    '30149': ['Iodine 133 organic bonded', 'I-133o'],
    '30150': ['Iodine 133 elementary gaseous and organic bonded', 'I-133go'],
    '30151': ['Iodine 133 aerosol', 'I-133a'],
    '30152': ['Iodine 134', 'I-134'],
    '30153': ['Iodine 134 elementary gaseous', 'I-134g'],
    '30154': ['Iodine 134 organic bonded', 'I-134o'],
    '30155': ['Iodine 135', 'I-135'],
    '30156': ['Iodine 135 elementary gaseous', 'I-135g'],
    '30157': ['Iodine 135 organic bonded', 'I-135o'],
    '30158': ['Iodine 135 elementary gaseous and organic bonded', 'I-135go'],
    ...
    '30295': ['Carbon-13', 'C-13'],
    '30296': ['Lead', 'Pb'],
    '30297': ['Tellurium 131', 'Te-131'],
    '30298': ['Neodymium 137', 'Nd-137'],
    '30299': ['Pseudo Radionuclide', 'unknown'],
    '30300': ['Silver 112', 'Ag-112'],
    '30301': ['Silver 115', 'Ag-115'],
    '30302': ['Barium 139', 'Ba-139'],
    '30303': ['Barium 141', 'Ba-141'],
    '30304': ['Barium 142', 'Ba-142'],
    '30305': ['Bromine 84', 'Br-84'],
    '30306': ['Cadmium 115', 'Cd-115'],
    '30307': ['Cadmium 117', 'Cd-117'],
    '30308': ['Cadmium 117 metastable', 'Cd-117m'],
    '30309': ['Cerium 145', 'Ce-145'],
    '30310': ['Cerium 146', 'Ce-146'],
    '30311': ['Cobalt 58 metastable', 'Ce-146'],
    '30312': ['Caesium 138', 'Cs-138'],
    '30313': ['Caesium 139', 'Cs-139'],
    '30314': ['Iodine 130 Aerosol', 'I-130a'],
    '30315': ['Iodine 130 Elementary Gaseous', 'I-130e'],
    '30316': ['Iodine 130 Organic Bonded', 'I-130o'],
    '30317': ['Iodine 132 Metastable', 'I-132m'],
    '30318': ['Iodine 134 Metastable', 'I-134m'],
    '30319': ['Indium 115 Metastable', 'In-115m'],
    '30320': ['Indium 117 Metastable', 'In-117m'],
    '30321': ['Krypton 83 Metastable', 'Kr-83m'],
    '30322': ['Lanthanum 142', 'La-142'],
    '30323': ['Lanthanum 143', 'La-143'],
    '30324': ['Manganese 56', 'Mn-56'],
    '30325': ['Molybdenum 101', 'Mo-101'],
    '30326': ['Molybdenum 102', 'Mo-102'],
    '30327': ['Neodymium 149', 'Nd-149'],
    '30328': ['Neodymium 151', 'Nd-151'],
    '30329': ['Palladium 109', 'Pd-109'],
    '30330': ['Palladium 112', 'Pd-112'],
    '30331': ['Praseodymium 145', 'Pr-145'],
    '30332': ['Praseodymium 146', 'Pr-146'],
    '30333': ['Praseodymium 147', 'Pr-147'],
    '30334': ['Rubidium 89', 'Rb-89'],
    '30335': ['Rubidium 90', 'Rb-90'],
    '30336': ['Rubidium 90 metastable', 'Rb-90m'],
    '30337': ['Rhodium 105 metastable', 'Rh-105m'],
    '30338': ['Rhodium 107', 'Rh-107'],
    '30339': ['Antimony 128', 'Sb-128'],
    '30340': ['Antimony 128 metastable', 'Sb-128m'],
    '30341': ['Antimony 129 metastable', 'Sb-129m'],
    '30342': ['Antimony 130', 'Sb-130'],
    '30343': ['Antimony 130 metastable', 'Sb-130m'],
    '30344': ['Antimony 131', 'Sb-131'],
    '30345': ['Antimony 132', 'Sb-132'],
    '30346': ['Antimony 132 metastable', 'Sb-132m'],
    '30347': ['Antimony 133', 'Sb-133'],
    '30348': ['Selenium 83', 'Se-83'],
    '30349': ['Tin 127', 'Sn-127'],
    '30350': ['Tin 127 metastable', 'Sn-127m'],
    '30351': ['Tin 128', 'Sn-128'],
    '30352': ['Tin 129 metastable', 'Sn-129m'],
    '30353': ['Tin 130', 'Sn-130'],
    '30354': ['Strontium 93', 'Sr-93'],
    '30355': ['Technetium 101', 'Tc-101'],
    '30356': ['Technetium 102', 'Tc-102'],
    '30357': ['Technetium 104', 'Tc-104'],
    '30358': ['Technetium 105', 'Tc-105'],
    '30359': ['Tellurium 133', 'Te-133'],
    '30360': ['Tellurium 133 metastable', 'Te-133m'],
    '30361': ['Tellurium 134', 'Te-134'],
    '30362': ['Yttrium 93 metastable', 'Y-93m'],
    '30363': ['Yttrium 94', 'Y-94'],
    '30364': ['Yttrium 95', 'Y-95'],
    '30365': ['Zirconium 96', 'Zr-96'],
    '30366': ['Indium 117', 'In-117'],
    '30367': ['Lead 203', 'Pb-203'],
    '30368': ['Sodium 24', 'Na-24'],
    '30369': ['Ruthenium 107', 'Ru-107'],
    '30370': ['Uranium 239', 'U-239'],
    '30371-39999': ['Reserved', 'unknown'],
    '40000': ['Singlet σ Oxygen (Dioxygen (σ Singlet))', 'O2(1σ+g)'],
    '40001': ['Singlet δ Oxygen (Dioxygen (δ Singlet))', 'O2(1δ+g)'],
    '40002': ['Singlet Excited Oxygen Atom', 'O(1D)'],
    '40003': ['Triplet Ground State Oxygen Atom', 'O(3P)'],
    '40004-59999': ['Reserved', 'unknown'],
    '60000': ['HOx Radical (OH+HO2)', 'HOx'],
    ...
    '60014': [
        'Anthropogenic Non-Methane Volatile Organic Compounds Expressed as Carbon',
        'aNMVOC',
    ],
    '60015': [
        'Biogenic Non-Methane Volatile Organic Compounds Expressed as Carbon',
        'bNMVOC',
    ],
    '60016': ['Lumped Oxygenated Hydrocarbons', 'OVOC'],
    '60017': ['NOx Expressed as Nirtogen Dioxide (NO2)', 'NOx'],
    '60018': ['Organic Aldehydes', 'RCHO'],
    '60019': ['Organic Peroxides', 'ROOH'],
    '60020': ['Organic Nitrates', 'RNO3'],
    '60021': ['Ethers', "ROR'"],
    '60022': ['Amines', "NRR'R''"],
    '60023': ['Ketones', "NRR'R''"],
    '60024': ['Dicarbonyls Unsaturated', "RC(O)CH2C(O)R'"],
    '60025': ['Hydroxy Dicarbonyls Unsaturated', "RC(O)CHOHC(O)R'"],
    '60026': ['Hydroxy Ketones', "RC(OH)C(O)R'"],
    '60027': ['Oxides', 'Ox'],
    '60028': ['Peroxyacyl Nitrates', 'RC(O)OONO2'],
    '60029': ['Aromatic Peroxide Radical (Aryl Dioxydanyl Radicals)', 'ArOO'],
    '60030': ['Biogenic Secondary Organic Compound', 'unknown'],
    '60031': ['Anthropogenic Secondary Organic Compound', 'unknown'],
    '60032': [
        'All Hydroxy-Peroxides Products of the Reaction of Hydroxy-Isoprene Adducts with O2',
        'ISOPOOH',
    ],
    '60033': ['Anthropogenic Volatile Organic Compounds', 'aVOC'],
    '60034': ['Biomass Burning Volatile Organic Compounds', 'bbVOC'],
    '60035-61999': ['Reserved', 'unknown'],
    ...
    '62023': ['Aerosol - High Absorption', 'unknown'],
    '62024': ['Reserved', 'unknown'],
    '62025': ['Volcanic Ash', 'unknown'],
    '62026': ['Particulate Matter (PM)', 'unknown'],
    '62027': ['Reserved', 'unknown'],
    '62028': ['Total Aerosol Hydrophilic', 'unknown'],
    '62029': ['Total Aerosol Hydrophobic', 'unknown'],
    '62030': ['Primary Particulate Inorganic Matter Dry', 'unknown'],
    '62031': ['Secondary Particulate Inorganic Matter Dry', 'unknown'],
    '62032': ['Biogenic Secondary Organic Aerosol', 'unknown'],
    '62033': ['Anthropogenic Secondary Organic Aerosol', 'unknown'],
    '62034': ['Rain Water', 'H2Orain'],
    '62035': ['Cloud Water', 'H2Ocloud'],
    '62036': ['Brown Carbon Dry', 'unknown'],
    '62037': ['Sea Salt Wet at 80% Relative Humidity', 'unknown'],
    '62038-62099': ['Reserved', 'unknown'],
    '62100': ['Alnus (Alder) Pollen', 'unknown'],
    '62101': ['Betula (Birch) Pollen', 'unknown'],
    '62102': ['Castanea (Chestnut) Pollen', 'unknown'],
    '62103': ['Carpinus (Hornbeam) Pollen', 'unknown'],
    '62104': ['Corylus (Hazel) Pollen', 'unknown'],
    '62105': ['Fagus (Beech) Pollen', 'unknown'],
    '62106': ['Fraxinus (Ash) Pollen', 'unknown'],
    '62107': ['Pinus (Pine) Pollen', 'unknown'],
    '62108': ['Platanus (Plane) Pollen', 'unknown'],
    '62109': ['Populus (Cottonwood, Poplar) Pollen', 'unknown'],
    '62110': ['Quercus (Oak) Pollen', 'unknown'],
    '62111': ['Salix (Willow) Pollen', 'unknown'],
    '62112': ['Taxus (Yew) Pollen', 'unknown'],
    '62113': ['Tilia (Lime, Linden) Pollen', 'unknown'],
    '62114': ['Ulmus (Elm) Pollen', 'unknown'],
    ...
    '62203': ['Plantago (Plantain) Pollen', 'unknown'],
    '62204': ['Rumex (Dock, Sorrel) Pollen', 'unknown'],
    '62205': ['Urtica (Nettle) Pollen', 'unknown'],
    '62206-62299': ['Reserved', 'unknown'],
    '62300': ['Poaceae (Grass Family) Pollen', 'unknown'],
    '62301-62999': ['Reserved', 'unknown'],
    '63000-65534': ['For Experimental Use at Local Level', 'unknown'],
...
table_4_238 = {
    ...
    '29': 'Nuclear weapon',
    '30': 'Commercial Building Heating',
    '31': 'Residential Heating',
    '32': 'Oil Refineries and Transformation Industry',
    '33': 'Gas Production',
    '34': 'Vegetation',
    '35': 'Biomass Burning',
    '36': 'Settlements',
...
table_scale_time_seconds = {
    ...
    '1': 3600.0,
    '2': float(3600.0 * 24.0),
    '3': float(3600.0 * 24.0 * 30.0),
    '4': float(3600.0 * 24.0 * 365.0),
    '5': float(3600.0 * 24.0 * 365.0 * 10.0),
    '6': float(3600.0 * 24.0 * 365.0 * 30.0),
    '7': float(3600.0 * 24.0 * 365.0 * 100.0),
    '8': 1.0,
    '9': 1.0,
    '10': float(3600.0 * 3.0),
    '11': float(3600.0 * 6.0),
    '12': float(3600.0 * 12.0),
    '13': 1.0,
    '14-255': 1.0,
}
