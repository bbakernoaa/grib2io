table_4_2_0_0 = {
    ...
    '24': [
        'Temperature Tendency due to Shortwave Radiation, Clear Sky',
        'K s-1',
        'TTSWRCS',
    ],
    '25': [
        'Temperature Tendency due to Longwave Radiation, Clear Sky',
        'K s-1',
        'TTLWRCS',
    ],
    ...
    '33-191': ['Reserved', 'unknown', 'unknown'],
...
table_4_2_0_1 = {
    ...
    '51': [
        'Total Column Water (Vertically Integrated Total Water (Vapor + Cloud Water/Ice))',
        'kg m-2',
        'TCWAT',
    ],
    ...
    '75': ['Graupel (Snow Pellets) Precipitation Rate', 'kg m-2 s-1', 'GPRATE'],
    ...
    '108': [
        'Specific Humidity Tendency due to Parameterizations',
        'kg kg-1 s-1',
        'SHTPRM',
    ],
    '109': [
    ...
    '160': [
        'Column integrated divergence of water vapor mass flux',
        'kg m-1s-1',
        'CDWFMF',
    ],
    '161': [
    ...
    '170': ['Mean Mass Diameter of Hail (see Note 10)', 'm', 'MEANHAIL'],
    '171': ['Estimated Maximum Diameter of Hail', 'm', 'MAXHAIL'],
    '172-191': ['Reserved', 'unknown', 'unknown'],
    '192-254': ['Reserved for Local Use', 'unknown', 'unknown'],
    ...
    '238': [
        'Hourly Maximum of 1-minute Average Precipitation Rate',
        'kg m-2 s-1',
        'PRATE1MIN',
    ],
    '239': [
        'Hourly Maximum of 5-minute Average Precipitation Rate',
        'kg m-2 s-1',
        'PRATE5MIN',
    ],
    '240': [
        'Hourly Maximum of 10-minute Average Precipitation Rate',
        'kg m-2 s-1',
        'PRATE10MIN',
    ],
...
table_4_2_0_2 = {
    ...
    '70-191': ['Reserved', 'unknown', 'unknown'],
    '192-254': ['Reserved for Local Use', 'unknown', 'unknown'],
    ...
    '215': ['ω (Dp/Dt) divided by density', 'K', 'OMGALF'],
    ...
    '233': [
        'Effective Layer Bulk Shear Magnitude (Inflow Base to 50% of EL)',
        'kt',
        'ESHR',
    ],
    '234': [
        'U Component Effective Layer Bulk Shear (Inflow Base to 50% of EL)',
        'kt',
        'UESH',
    ],
    '235': [
        'V Component Effective Layer Bulk Shear (Inflow Base to 50% of EL)',
        'kt',
        'VESH',
    ],
...
table_4_2_0_4 = {
    ...
    '5': ['Radiance (with respect to wavenumber)', 'W m-1 sr-1', 'LWRAD'],
    ...
    '15': [
        'Upward UV radiation emitted/reflected from the Earths surface',
        'W m-2',
        'UVVEARTH',
    ],
    '16-49': ['Reserved', 'unknown', 'unknown'],
...
table_4_2_0_7 = {
    ...
    '23-191': ['Reserved', 'unknown', 'unknown'],
    '192-254': ['Reserved for Local Use', 'unknown', 'unknown'],
...
table_4_2_0_18 = {
    ...
    '6': [
        'Time Integrated Air Concentration of Cesium Pollutant',
        'Bq s m-3',
        'TIACCP',
    ],
    '7': [
...
table_4_2_0_19 = {
    ...
    '53-191': ['Reserved', 'unknown', 'unknown'],
    '192-254': ['Reserved for Local Use', 'unknown', 'unknown'],
    ...
    '217': ['Supercooled Large Droplet (SLD) Icing', 'See Table 4.207', 'SIPD'],
    ...
    '227-231': ['Reserved', 'unknown', 'unknown'],
    '232': [
...
table_4_2_0_20 = {
    ...
    '20-49': ['Reserved', 'unknown', 'unknown'],
    ...
    '85-99': ['Reserved', 'unknown', 'unknown'],
    ...
    '114-191': ['Reserved', 'unknown', 'unknown'],
    '192-254': ['Reserved for Local Use', 'unknown', 'unknown'],
    '255': ['Missing', 'unknown', 'unknown'],
}
table_4_2_0_190 = {
