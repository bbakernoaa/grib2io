table_4_2_10_0 = {
    ...
    '105-191': ['Reserved', 'unknown', 'unknown'],
...
table_4_2_10_4 = {
    ...
    '16': ['Water Density (ρ)', 'kg m-3', 'WATERDEN'],
    '17': ['Water Density Anomaly (σ)', 'kg m-3', 'WATDENA'],
    '18': ['Water Potential Temperature (θ)', 'K', 'WATPTEMP'],
    '19': ['Water Potential Density (ρ θ)', 'kg m-3', 'WATPDEN'],
    '20': ['Water Potential Density Anomaly (σ θ)', 'kg m-3', 'WATPDENA'],
    ...
    '34': [
        'Sea Water Temperature Tendency due to Newtonian Relaxation',
        'K s-1',
        'SWTTNR',
    ],
    '35': [
    ...
    '44': [
        'Sea water column integrated meridional volume transport',
        'm 3 m -2 s -1',
        'SEACMVT',
    ],
    '45': [
        'Sea water column integrated zonal volume transport',
        'm 3 m -2 s -1',
        'SEACZVT',
    ],
    ...
    '48': [
        'Sea water column integrated meridional mass transport',
        'kg m -2 s -1',
        'SEACMMT',
    ],
    '49': [
        'Sea water column integrated zonal mass transport',
        'kg m -2 s -1',
        'SEACZMT',
    ],
    ...
    '59-191': ['Reserved', 'unknown', 'unknown'],
    '192-254': ['Reserved for Local Use', 'unknown', 'unknown'],
