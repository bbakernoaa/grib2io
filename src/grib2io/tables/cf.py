...
table_shortname_to_cf = {
    ...
    'C2H5OHMR': {
        'cf_standard_name': 'mass_fraction_of_ethanol_in_air',
        'cf_cell_methods': None,
    },
    'CH3CHOMR': {
        'cf_standard_name': 'mass_fraction_of_acetaldehyde_in_air',
        'cf_cell_methods': None,
    },
    'CH3COCH3MR': {
        'cf_standard_name': 'mass_fraction_of_acetone_in_air',
        'cf_cell_methods': None,
    },
    'DMSMR': {
        'cf_standard_name': 'mass_fraction_of_dimethyl_sulfide_in_air',
        'cf_cell_methods': None,
    },
    'bc_mmr': {
        'cf_standard_name': 'mass_fraction_of_black_carbon_dry_aerosol_in_air',
        'cf_cell_methods': None,
    },
    'du_mmr': {
    ...
    'ss_mmr': {
        'cf_standard_name': 'mass_fraction_of_seasalt_dry_aerosol_in_air',
        'cf_cell_methods': None,
    },
    'so4_mmr': {
        'cf_standard_name': 'mass_fraction_of_sulfate_dry_aerosol_in_air',
        'cf_cell_methods': None,
    },
    'om_mmr': {
        'cf_standard_name': 'mass_fraction_of_organic_matter_dry_aerosol_in_air',
        'cf_cell_methods': None,
    },
    'PM10': {
