...
table_4_2_3_1 = {
    ...
    '25-26': ['Reserved', 'unknown', 'unknown'],
    ...
    '33-97': ['Reserved', 'unknown', 'unknown'],
    '98': [
...
table_4_2_3_2 = {
    ...
    '31': ['Upper layer cloud optical depth', 'Numeric', 'unknown'],
    '32': ['Upper layer cloud top pressure', 'Pa', 'unknown'],
    '33': ['Upper layer cloud effective radius', 'm', 'unknown'],
    '34': [
        'Error in upper layer cloud optical depth(see Note 1)',
        'Numeric',
        'unknown',
    ],
    '35': ['Error in upper layer cloud top pressure', 'Pa', 'unknown'],
...
table_4_2_3_192 = {
    ...
    '86': [
        'Simulated Brightness Temperature for SSMIS-F17, Channel 12',
        'K',
        'SSMS1712',
    ],
    '87': [
        'Simulated Brightness Temperature for SSMIS-F17, Channel 13',
        'K',
        'SSMS1713',
    ],
